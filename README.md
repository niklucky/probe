...
Named browser authentication states are configured with QA-friendly Test
profiles. Profiles are explicit, non-inheriting, encrypted browser states with
fail-closed status and revision checks; see [Test profiles](docs/environment-profiles.md).
